            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        <Nav.Link href="App.js" style={{ color: "white", fontSize: "20px" }}><Link to="/">Home</Link></Nav.Link>
                        <Nav.Link href="../faq.js" style={{ color: "white", fontSize: "20px" }}><Link to="/faq">Faq</Link></Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
